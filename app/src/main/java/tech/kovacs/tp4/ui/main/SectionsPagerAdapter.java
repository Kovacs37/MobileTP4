...
public class SectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            ...
            case 3:
                return SeasonFragment.newInstance(2, mContext.getString(R.string.titre4));
            case 4:
                return SeasonFragment.newInstance(2, mContext.getString(R.string.titre0));
        }
        return null;
   //     return PlaceholderFragment.newInstance(position + 1);
    ...
    public CharSequence getPageTitle(int position) {
        ...
        switch (position) {
            ...
            case 4:
                return mContext.getString(R.string.titre0).toUpperCase(l);
        }
        return null;
    }
